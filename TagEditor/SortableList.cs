...
namespace EMK.Collections
{
	...
	public class SortableList : IList, ICloneable
	{
		...
		public bool Contains(object O)
		{
			...
			return _IsSorted ? _List.BinarySearch(0, _List.Count, O, _Comparer) >= 0 : _List.Contains(O);
		}
		...
		public int IndexOf(object O)
		{
			...
			if ( _IsSorted )
			{
				...
				Result = _List.BinarySearch(0, _List.Count, O, _Comparer);
		...
		public int IndexOf(object O, int Start)
		{
			...
			{
				Result = _List.IndexOf(O, Start, (_List.Count - Start));
			}
			return Result;
		}
